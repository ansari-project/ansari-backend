...
def test_ayah_claude_endpoint_loads_correct_system_prompt():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("anthropic.Anthropic") as mock_anthropic:
            ...
            ansari_ayah = AnsariClaude(mock_settings, system_prompt_file=mock_settings.AYAH_SYSTEM_PROMPT_FILE_NAME)
            ...
            if api_call_args:
                # TODO: Add system prompt content verification if needed
