...
threads_pct = results["threads_with_tools"] / results["total_threads"] * 100
print(f"  Threads with tool usage: {results['threads_with_tools']:,} ({threads_pct:.1f}%)")
print(f"  Total messages: {results['total_messages']:,}")
messages_pct = results["messages_with_tools"] / results["total_messages"] * 100
print(f"  Messages with tool usage: {results['messages_with_tools']:,} ({messages_pct:.1f}%)")
